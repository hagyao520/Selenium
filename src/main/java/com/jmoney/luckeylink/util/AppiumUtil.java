	...
	public static WebElement getElement(TestStep step) throws Exception{
		try{
			String loc = step.getLocator();
			   ...
			   locindex = Integer.valueOf(loc.substring(idx2+1,loc.length()-1));
...
//		    AndroidXmlParseService.screenShot("case2");
 	    }
