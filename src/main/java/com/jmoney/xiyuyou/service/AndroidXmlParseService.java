...
import com.jmoney.xiyuyou.service.AppiumService;
...
//		Runtime.getRuntime().exec("adb -s MKJNW18129003635 uninstall com.giveu.corder"); 
		File apk = new File(ConfigUtil.getProperty("apk.path", Constants.CONFIG_COMMON), "JMDTest.apk");
		DesiredCapabilities capabilities = new DesiredCapabilities();
		capabilities.setCapability("device", "uiautomator");
		capabilities.setCapability("platformName", "Android");
		capabilities.setCapability("platformVersion", "8.0");
		capabilities.setCapability("deviceName", "MKJNW18129003635");
        capabilities.setCapability("udid", "MKJNW18129003635");
		capabilities.setCapability("noReset", true);
		capabilities.setCapability("fullReset", false);
		capabilities.setCapability("app", apk.getAbsolutePath());
		capabilities.setCapability("sessionOverride", false);
